      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="py-12 md:py-20">
          ...
          <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 class="h2 font-cabinet-grotesk">ABOUT US</h2>
          </div>
        ...
        <div class="max-w-xl mx-auto pb-10">
          <h4 class="h4 font-cabinet-grotesk">Tangale Momentum for Empowerment (TME)</h4>
        </div>

        <div class="max-w-xl font-medium text-gray-900 mx-auto space-y-6">
    
            
  <p>Tangale Momentum for Empowerment (TME) is a non-profit organization that is committed to promoting entrepreneurship and economic development in Tangale land. We believe that by empowering men and women with the skills, knowledge, and resources they need to start and grow successful businesses, we can drive economic growth, create jobs, and reduce poverty in our community.</p>
  <p>Our mission is to facilitate the empowerment of men and women in Tangale land, accelerate economic growth through business and job creation, drive poverty reduction, and create a commonwealth fund for the Tangale nation.</p>
  <p>We achieve this through a range of programs and initiatives, including our Entrepreneurship Program, which provides mentorship, training, and financial assistance to small businesses. We also offer an online Knowledge Resource platform, quarterly business meetings, and an annual TME Entrepreneurship Forum, where entrepreneurs can connect with potential investors and partners.</p>
  <p>At TME, we are guided by a set of core values, including integrity, accountability, community-based, growth mindset and honesty. These values inform everything we do and are the foundation of our organization.</p>
  <p>We are proud of the impact we have had in the Tangale community thus far and are excited to continue working together to drive economic development and improve the lives of the people of Tangale land.</p>
</div>

      ...
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <nav class="flex grow">
          ...
          <ul class="flex grow justify-end flex-wrap items-center">
            <li>
              <router-link class="font-cabinet-grotesk text-sm font-bold text-white underline hover:no-underline flex items-center" to="/signin">Sign in</router-link>
            </li>
            <li class="ml-6">
              <router-link class="btn-sm inline-flex items-center text-white bg-gray-900 hover:bg-gray-800 group" to="/proposal-call">
                APPLY
